<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddAdmin.aspx.cs" Inherits="HospitalManagementSystem.AddAdmin" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">          
                                <center>
                                    <img width="120" src="imgs/adminuser.png" />
                                  </center>
                            </div>
                        ...
                        <div class="row pb-3">
                            ...
                            <div class="row col-12 py-4" style="margin-top:10px;">
                             ...
                             <div class="col-md-4 ">
                             <asp:Button CssClass="btn btn-success btn-lg btn-block" ID="Button3" runat="server" Text=" Add Admin" OnClick="Button3_Click"/>
                              </div>
                              <div class="col-md-4 ">
                                  <asp:Button CssClass="btn btn-warning btn-lg btn-block" ID="Button1" runat="server" Text="Update " OnClick="Button1_Click"/>
                                   </div>
                                       <div class="col-md-4 ">
                                   <asp:Button CssClass="btn btn-lg btn-block btn-danger" ID="Button2" runat="server" Text="Remove Admin" OnClick="Button2_Click" />
                                  </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HospitalDBConnectionString %>" SelectCommand="SELECT * FROM [admin_master_tbl]"></asp:SqlDataSource>
                            <div class="col">
