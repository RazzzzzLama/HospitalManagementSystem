<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LabLogin.aspx.cs" Inherits="HospitalManagementSystem.LabLogin" %>
            ...
            <div class="col-5 py-4">
               ...
               <a href="Home.aspx"> <i class=" fa fa-home" style="color:orange; font-size:20px;"></i></a>
                <a href="Home.aspx" style="color:gray" > Back to home</a><br /><br />
                                <center>
                                    <img width="150" src="imgs/Science.png" />
