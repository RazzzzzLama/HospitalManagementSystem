    ...
    public partial class LabLogin : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from LabMember_master_tbl where user_id='" + TextBox1.Text.Trim() + "' AND password='" + TextBox2.Text.Trim() + "'", con);
                ...
                if (dr.HasRows) // Use sql querie and getting values from (dr i.e data reader) data table.
                {
                    ...
                    Response.Write("<script>alert('Hello "+ Session["fullname"] + "');</script>");
                    Server.Transfer("ReportInventory.aspx");
                }
